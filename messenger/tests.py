...
class ThreadTestCase(TestCase):
    def setUp(self):
        self.user1 = User.objects.create_user('user1', None, 'abcd1234')
        self.user2 = User.objects.create_user('user2', None, 'abcd1234')
        self.user3 = User.objects.create_user('user3', None, 'abcd1234')
